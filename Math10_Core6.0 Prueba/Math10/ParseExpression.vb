        ...
        Try
            ...
            ElseIf m.Groups("num").Success Then
                If G10.currBase = Rational_1.base.Decimal Then
                    ...
                    Dim rtn As Rational_1 = Rational_1.ParseRational(m.Value)
                    value = New Expression(New Complex(rtn.ToDouble))
                Else
                    Dim dec As Decimal
    ...
    Private Function TryParseHexDecOctBinBaseNum(str As String, ByRef result As Decimal) As Boolean
        ...
        Try
            Select Case G10.currBase
                Case Rational_1.base.Hexadecimal
                    sPattern = "[^.0-9abcdef]"
                    base = 16
                    ns = Globalization.NumberStyles.HexNumber
                Case Rational_1.base.Decimal
                    sPattern = "[^.0-9]"
                    base = 10
                    ns = Globalization.NumberStyles.Integer
                Case Rational_1.base.Octal
                    sPattern = "[^.0-7]"
                    base = 8
                Case Rational_1.base.Binary
                    sPattern = "[^.01]"
                    base = 2
            End Select
