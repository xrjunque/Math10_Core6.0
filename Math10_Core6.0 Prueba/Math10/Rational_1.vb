...
Public Class Rational_1
    ...
    Dim tipo As Double = 0.0
    Dim bReduced As Boolean = False
    Dim bReduce As Boolean = True
    Public Sub New()
    End Sub

    Public Sub New(ByVal opB As Rational_1)
        Me.CopyFrom(opB)
    End Sub
    Public Sub CopyFrom(ByVal opB As Rational_1)
    ...
    Public Sub New(ByVal num As Double, ByVal den As Double)
        Try
            ...
            Double.IsInfinity(den) OrElse Double.IsNaN(den) Then
                ...
                Exit Try
            End If
            Dim rNum As New Rational_1(num)
            Dim rDen As New Rational_1(den)
        ...
        End Try
    End Sub
    Public Shared Function ParseRational(ByVal s As String, Optional cultureInfo As Globalization.CultureInfo = Nothing) As Rational_1
        Dim rtn As New Rational_1
        Try
        ...
        Return rtn
    End Function
    Public Shared Function ParseFraction(sNum As String) As Rational_1
        Dim r As New Rational_1()
        Try
            Dim ve1() As String = Split(sNum, "/")
            Dim N As Rational_1 = ParseRational(ve1(0))
            Dim D As Rational_1 = ParseRational(ve1(1))
    ...
    Public ReadOnly Property Den() As Double
        ...
        End Get
    End Property
    Public Function OpCompara(ByVal opB As Rational_1) As Int64
    ...
    End Function
    Public Function OpCompara(ByVal opB As Rational_1, ByVal redondeo As Boolean) As Int64
        Dim dif As Int64 = Math.Sign(Sign - opB.Sign)
    ...
    End Function
    Public Sub OpSuma(ByVal opB As Rational_1)
        Try
        ...
        End Try
    End Sub
    Public Shared Function OpSuma(ByVal opA As Rational_1, ByVal opB As Rational_1) As Rational_1
        Dim opC As New Rational_1(opA)
        opC.OpSuma(opB)
        Return opC
    End Function
    Public Shared Function OpResta(ByVal opA As Rational_1, ByVal opB As Rational_1) As Rational_1
        Dim opC As New Rational_1(opA)
        opC.OpSuma(-opB)
        Return opC
    End Function
    Public Sub OpMult(ByVal opB As Rational_1)
        Try
            If tipo OrElse opB.tipo Then
                If opB.tipo = 0 Then
                    tipo *= opB.ToDouble
        ...
        End Try
    End Sub
    Public Shared Function OpMult(ByVal opA As Rational_1, ByVal opB As Rational_1) As Rational_1
        Dim opC As New Rational_1(opA)
        opC.OpMult(opB)
        Return opC
    End Function
    Public Sub OpMult(ByVal db As Double)
        Try
            Dim opB As New Rational_1(db)
            Me.OpMult(opB)
        Catch ex As Exception
            Throw
        End Try
    End Sub
    Public Shared Function OpMult(ByVal opA As Rational_1, ByVal db As Double) As Rational_1
        Dim opC As New Rational_1(opA)
        opC.OpMult(db)
        Return opC
    End Function
    Public Sub OpDiv(ByVal opB As Rational_1)
        Try
            If opB.IsZero Then
                If IsZero() Then
                    CopyFrom(New Rational_1(Double.NaN))
                Else
                    CopyFrom(New Rational_1(ToDouble / 0.0))
                End If
                Exit Try
            ElseIf tipo OrElse opB.tipo Then
                CopyFrom(New Rational_1(ToDouble / opB.ToDouble))
                Exit Try
            End If
            If opB.bReduced Then bReduced = True
    ...
    Public Shared Function OpDiv(ByVal opA As Rational_1, ByVal opB As Rational_1) As Rational_1
        Dim opC As New Rational_1(opA)
        opC.OpDiv(opB)
        Return opC
    End Function
    ...
    Public Shared Function opFactors(db As Double) As Double()
        ...
        Try
            ...
            Else
                Dim iv As Int64 = 0
                For i As Int64 = 0 To G10.vPrime.Length - 1
                    Dim div As Double = db / G10.vPrime(i)
        ...
        Return ret
    End Function
    Public Shared Function OpMod(ByVal opA As Rational_1, ByVal opB As Rational_1) As Double
    ...
    End Sub
    Public Function Abs() As Rational_1
        Dim prC As New Rational_1(Me)
        prC.Numerator = BigInteger.Abs(Numerator)
        prC.Denominator = BigInteger.Abs(Denominator)
        Return prC
    End Function
    Public Shared Operator =(ByVal prA As Rational_1, ByVal prB As Rational_1) As Boolean
    ...
    Public Shared Operator <(ByVal prA As Rational_1, ByVal prB As Rational_1) As Boolean
        ...
        Return prC.Sign = -1
    End Operator
    Public Shared Operator +(ByVal prA As Rational_1, ByVal prB As Rational_1) As Rational_1
        Return Rational_1.OpSuma(prA, prB)
    End Operator
    Public Shared Operator +(ByVal dbA As Double, ByVal prB As Rational_1) As Rational_1
        Return Rational_1.OpSuma(New Rational_1(dbA), prB)
    End Operator
    Public Shared Operator +(ByVal prA As Rational_1, ByVal dbB As Double) As Rational_1
        Return Rational_1.OpSuma(prA, New Rational_1(dbB))
    End Operator
    Public Shared Operator -(ByVal prA As Rational_1, ByVal prB As Rational_1) As Rational_1
        Return Rational_1.OpResta(prA, prB)
    End Operator
    Public Shared Operator -(ByVal dbA As Double, ByVal prB As Rational_1) As Rational_1
        Return Rational_1.OpResta(New Rational_1(dbA), prB)
    End Operator
    Public Shared Operator -(ByVal prA As Rational_1, ByVal dbB As Double) As Rational_1
        Return Rational_1.OpResta(prA, New Rational_1(dbB))
    End Operator
    Public Shared Operator -(ByVal prA As Rational_1) As Rational_1
        Dim prB As New Rational_1(prA)
        prB.OpChgSgn()
        Return prB
    End Operator
    Public Shared Operator *(ByVal prA As Rational_1, ByVal prB As Rational_1) As Rational_1
        Return Rational_1.OpMult(prA, prB)
    End Operator
    Public Shared Operator *(ByVal dbA As Double, ByVal prB As Rational_1) As Rational_1
        Return Rational_1.OpMult(New Rational_1(dbA), prB)
    End Operator
    Public Shared Operator *(ByVal prA As Rational_1, ByVal dbB As Double) As Rational_1
        Return Rational_1.OpMult(prA, New Rational_1(dbB))
    End Operator
    Public Shared Operator /(ByVal prA As Rational_1, ByVal prB As Rational_1) As Rational_1
        Return Rational_1.OpDiv(prA, prB)
    End Operator
    Public Shared Operator /(ByVal dbA As Double, ByVal prB As Rational_1) As Rational_1
        Return Rational_1.OpDiv(New Rational_1(dbA), prB)
    End Operator
    Public Shared Operator /(ByVal prA As Rational_1, ByVal dbB As Double) As Rational_1
        Return Rational_1.OpDiv(prA, New Rational_1(dbB))
    End Operator
    Public Shared Operator ^(ByVal prA As Rational_1, ByVal prB As Rational_1) As Rational_1
        Return Rational_1.opPow(prA, prB.ToDouble)
    End Operator
    Public Shared Operator ^(ByVal prA As Rational_1, ByVal dbB As Double) As Rational_1
        Return Rational_1.opPow(prA, dbB)
    End Operator
    Public Shared Function opPow(ByVal opA As Rational_1, ByVal expB As Double) As Rational_1
        Dim opC As New Rational_1(0.0)
        Try
            If Double.IsInfinity(expB) Then
                If opA.tipo = 0 Then
                    Dim db1 = opA.ToDouble
                    If db1 = 1.0 Then
                        opC = New Rational_1(Double.NaN)
                    Else
                        opC = New Rational_1(db1 ^ expB)
                    End If
                    Exit Try
                End If
            ...
            If (Not Double.IsInfinity(toDbl) AndAlso toDbl <> 1.0) OrElse lnDen.IsZero Then
                ...
                db = Math.Pow(db, expB)
                opC = New Rational_1(db)
            Else
                Dim db As Double
                ' opC = opA ^expB = exp(expB * log(opA.Num/opA.Den))
                Dim expR As New Rational_1(expB)
    ...
    Public Shared Function toStringBase(ByVal db As Double,
                                        ...
                                        base As Rational_1.Base) As String
        Dim sDb As String
        Dim sgn As Int64
        Try
            sgn = Math.Sign(db)
            ...
            Dim i As Int64
            If base =
            Rational_1.Base.Decimal Then
                sDb = db.ToString(cultureInfo)

            ElseIf base = Rational_1.Base.Hexadecimal Then
                sDb = UCase(Hex(db1))
                If fra Then
            ...
            ElseIf base = Rational_1.Base.Octal Then
        ...
        Try
            ...
            End If
            'Select Case base
            '    Case Rational_1.Base.Hexadecimal : sDb = "&h" + sDb
            '    Case Rational_1.Base.Octal : sDb = "&o" + sDb
            '    Case Rational_1.Base.Hexadecimal : sDb = "&b" + sDb
            'End Select
        Catch ex As Exception
    ...
    Public Overrides Function toString() As String
        Return ToStringRational_1(G10.nDec, G10.CI, G10.currBase)
    End Function
    Public Enum Base
        Hexadecimal
        [Decimal]
    ...
    Public Function ToStringRational_1(Optional numDecimals As Int32 = 15,
        ...
        Try
            ...
            End If
            reduce()
            If currBase = Rational_1.Base.Decimal Then
                ...
                If Not bReduced Then
                    ' Find out if it is a stored irRational_1:
            ...
            sNum = Rational_1.toStringBase(Me.Num, nDec, cultureInfo, currBase)
            sDen = Rational_1.toStringBase(Me.Den, nDec, cultureInfo, currBase)
