        ...
        Try
            ...
            varA(0) <> varB(0) Then
                If varA.Length = 0 AndAlso pA.IsRational Then
                    ...
                    num = Math.Abs(num)
                    Dim vFac() As Double = Rational_1.opFactors(num)
    ...
    Public Shared Function LCM_GCD(a() As Double, Optional ByRef sDetail As String = "") As Double()
        ...
        Try
            ...
            For i As Int64 = 0 To cols - 1
                ...
                End If
                For j As Int64 = 0 To g10.vPrime.Length - 1
                    Dim prime As Double = g10.vPrime(j)
                ...
                For i As Int64 = 0 To cols - 1
                    ...
                    For j = 0 To iv
                        If vExp(i)(j) Then
                            ...
                            End If
                            If vExp(i)(j) = 1 Then
                                e1 += g10.vPrime(j).ToString
                            Else
                                e1 += g10.vPrime(j).ToString + "^" + vExp(i)(j).ToString
                            End If
                        End If
                    Next
                    G10.sDetail += e1
            ...
            For j = 0 To iv
                If vMax(j) Then
                    lcm *= g10.vPrime(j) ^ vMax(j)
                End If
                If vMin(j) Then
                    gcd *= g10.vPrime(j) ^ vMin(j)
                End If
            Next
            dbRet(0) = gcd
            dbRet(1) = lcm
