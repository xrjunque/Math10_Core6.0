                ...
                Select Case i
                    ...
                    Case 2
                        ...
                        Select Case G10.currBase
                            Case Rational_1.Base.Decimal : index = 0
                            Case Rational_1.Base.Hexadecimal : index = 1
                            Case Rational_1.Base.Octal : index = 2
                            Case Rational_1.Base.Binary : index = 3
                        End Select
        ...
        Try
            ...
            If lst.Count Then
                ...
                Select Case Name
                    ...
                    Case "base"
                        If InStr(value, "&d") Then G10.currBase = Rational_1.Base.Decimal
                        If InStr(value, "&h") Then G10.currBase = Rational_1.Base.Hexadecimal
                        If InStr(value, "&o") Then G10.currBase = Rational_1.Base.Octal
                        If InStr(value, "&b") Then G10.currBase = Rational_1.Base.Binary
                    Case "angle"
