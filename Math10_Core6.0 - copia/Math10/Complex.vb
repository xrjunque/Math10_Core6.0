...
Public Class Complex
    ...
    Public Shared Operator *(ByVal cjoA As Complex, ByVal cjoB As Complex) As Complex
        ...
        If G10.detail Then
            Dim s As String = ""
            Dim sReA As String = IIf(cjoA.pRe.IsZero, "", cjoA.pRe.ToStringRational(G10.nDec, G10.sImg, G10.CI))
            Dim sImA As String = IIf(cjoA.pIm.IsZero, "", cjoA.pIm.ToStringRational(G10.nDec, G10.sImg, G10.CI))
            Dim sReB As String = IIf(cjoB.pRe.IsZero, "", cjoB.pRe.ToStringRational(G10.nDec, G10.sImg, G10.CI))
            Dim sImB As String = IIf(cjoB.pIm.IsZero, "", cjoB.pIm.ToStringRational(G10.nDec, G10.sImg, G10.CI))
        ...
        If G10.detail Then
            Dim s As String = ""
            s = prRe.ToStringRational(G10.nDec, G10.sImg, G10.CI)
            If Not prIm.IsZero Then
                s += "+i*" + prIm.ToStringRational(G10.nDec, G10.sImg, G10.CI)
            End If
            G10.sDetail += s
        End If
        Return New Complex(prRe, prIm)
    ...
    Public Shared Operator /(ByVal cjoA As Complex, ByVal cjoB As Complex) As Complex
        ...
        If G10.detail Then
            ...
            sa = a.ToStringRational(G10.nDec, G10.sImg, G10.CI)
            sb = b.ToStringRational(G10.nDec, G10.sImg, G10.CI)
            sc = c.ToStringRational(G10.nDec, G10.sImg, G10.CI)
            sd = d.ToStringRational(G10.nDec, G10.sImg, G10.CI)
            sDen = "(" + sc + "*" + sc + "+" + sd + "*" + sd + ")"
        End If
